...
: ${AMENT_CURRENT_PREFIX:="/root/autodl-tmp/ros2_ws/install/my_fastbev"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_fastbev/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_fastbev/environment/path.sh"
